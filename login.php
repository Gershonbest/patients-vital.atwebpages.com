...
<head>
  ...
  <title>IoT health monitor system| Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>Doctor or Health Administrator  </b>Login</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Log in as Doctor or Admin </p>
