...
<head>
  ...
  <title>Iot health| Register</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>Doctor or Health Administrator  </b>Register</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <div class="input-group mb-3">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block" name="submit" >Register</button><br>
          </div>
          <div class="col-12">
