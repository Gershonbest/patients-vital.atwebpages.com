...
if(!isset($_SESSION['loggedin_a'])){
  ...
  <link rel="stylesheet" href="./guage.css">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">All Patients Health Recorded</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
//$sql="SELECT attendance_sheet.id AS ID, attendance_sheet.stdno AS stno, attendance_sheet.course_id, attendance_sheet.room_id,  attendance_sheet.Date, attendance_sheet.Time, attendance_sheet.Time_out, students.Name, students.Surname, students.stdno FROM attendance_sheet LEFT JOIN students on attendance_sheet.stdno = students.stdno ORDER BY ID DESC";
